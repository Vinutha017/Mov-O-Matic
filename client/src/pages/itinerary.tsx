...
import { ArrowLeft, Download, MapPin, Calendar, Users, DollarSign, Cloud } from "lucide-react";
...
export default function Itinerary() {
  ...
  const weatherStartDate = toIsoStringSafe(trip.startDate)?.split('T')[0];
  const weatherEndDate = toIsoStringSafe(trip.endDate)?.split('T')[0];
  // Share link and WhatsApp helpers removed
      ...
      <div className="travel-container py-8 pdf-content">
        ...
        <div className="pdf-title-section mb-8">
          <div className="text-center border-b pb-4">
            ...
            <p className="text-xs text-gray-500">Generated by Planora Travel Planner</p>
          </div>
        </div>
        ...
        {/* Booking Options */}
        <BookingOptions
          origin={trip.metadata?.travelInfo?.startLocation}
          destination={trip.destination}
